CREATE_HOTEL_EXAMPLE = {
    "1": {
        ...
        "value": {
            ...
            "location": "Владивосток, ул.Советская, д.20",
        },
    },
    "2": {
        "summary": "С существующим title",
        "value": {"title": "Горящие вершины", "location": "Сочи, ул.Ленина, д.20"},
    },
...
UPDATE_HOTEL_EXAMPLE = {
    "1": {
        ...
        "value": {"title": "Горящие вершины", "location": "Сочи, ул.Советская, д.20"},
    },
...
EDIT_HOTEL_EXAMPLE = {
    "1": {
        "summary": "Все поля",
        "value": {"title": "Курорт в Сочи", "location": "Сочи, ул.Советская, д.20"},
    },
